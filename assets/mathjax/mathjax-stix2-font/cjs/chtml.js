...
var double_struck_italic_js_1 = require("./chtml/double-struck-italic.js");
...
var up_dsp_js_1 = require("./chtml/up-dsp.js");
var delimiters_js_1 = require("./chtml/delimiters.js");
var Base = (0, common_js_1.CommonMathJaxStix2FontMixin)(FontData_js_1.ChtmlFontData);
var MathJaxStix2Font = (function (_super) {
    __extends(MathJaxStix2Font, _super);
    function MathJaxStix2Font() {
        var _this = _super.apply(this, __spreadArray([], __read(arguments), false)) || this;
        _this.cssFontPrefix = 'STX';
        return _this;
    }
    MathJaxStix2Font.NAME = 'MathJaxStix2';
    MathJaxStix2Font.OPTIONS = __assign(__assign({}, Base.OPTIONS), { fontURL: '@mathjax/mathjax-stix2-font/js/chtml/woff2', dynamicPrefix: '@mathjax/mathjax-stix2-font/js/chtml/dynamic' });
    ...
    MathJaxStix2Font.defaultStyles = __assign(__assign({}, FontData_js_1.ChtmlFontData.defaultStyles), { 'mjx-container[jax="CHTML"] > mjx-math.STX-N[breakable] > *': {
    ...
    MathJaxStix2Font.defaultFonts = __assign(__assign({}, FontData_js_1.ChtmlFontData.defaultFonts), { '@font-face /* MJX-STX-ZERO */': {
    ...
    MathJaxStix2Font.dynamicFiles = FontData_js_1.ChtmlFontData.defineDynamicFiles([
        ['latin', {
                'normal': [
